...
| `importing` | Previsualización, validación e importación de archivos | Fase 4 — **existe** (`domain/` + `application/` + `infrastructure/` LEX-4.2: parser delimitado tras puerto; `presentation/` en LEX-4.4; validación y saneamiento LEX-4.5) |
