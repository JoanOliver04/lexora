...
| `importing` | Previsualización, validación e importación de archivos | Fase 4 — **existe** (parser LEX-4.2; preview LEX-4.4; saneamiento LEX-4.5; duplicados LEX-4.6; lote LEX-4.7; wizard LEX-4.8; resumen LEX-4.9; dataset real LEX-4.10) |
