...
**Estado resultante:** `HECHO`. PR #81 fusionada a `main` (merge `03a6d54`);
CI verde en los tres trabajos, runs `34607003177` (PR) y `34607509543`
(merge).
...
CI verde, tres trabajos: run `34607003177` (PR #81) y run `34607509543`
(merge).
