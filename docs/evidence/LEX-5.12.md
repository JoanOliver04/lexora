...
**Estado resultante:** `HECHO`. PR #91 fusionada a `main` (merge `46427cc`);
CI verde en los tres trabajos, runs `34618993838` (PR) y `34619533416`
(merge).
...
CI verde, tres trabajos: run `34618993838` (PR #91) y run `34619533416`
(merge).
