...
select is(('front_too_long'::public.import_error_code)::text, 'front_too_long',
  'front_too_long is a usable import_error_code (LEX-4.5)');
select is(('back_too_long'::public.import_error_code)::text, 'back_too_long',
